...
|| `references/custodian-error-investigation.md` | When a finch:work task involves a custodian error (e.g., <other-ocas-skill>:deep Broken pipe) — investigation pattern for journal files and issues.jsonl ||
