...
| File | Why off-limits |
|---|---|
| **USER.md** | <owner>'s profile. Only <owner> edits. Finch can *suggest* changes but never auto-apply. |
...
- **Don't auto-apply config changes** — suggest to <owner> first
...
- **USER.md is <owner>'s file** — if finch detects a user preference change, suggest it to <owner>. Don't auto-edit USER.md.
